...
export const dict = {
  ...
  "session.panel.debug": "调试面板",
  "session.debug.empty": "暂无调试数据",
  "session.debug.provider": "提供商",
  "session.debug.model": "模型",
  "session.debug.system": "System Prompt Token（估算）",
  "session.debug.total": "总 Token",
  "session.debug.input": "输入 Token",
  "session.debug.output": "输出 Token",
  "session.debug.reasoning": "推理 Token",
  "session.debug.cache": "缓存读 / 写",
  "session.debug.tokensUnit": "token",
  "session.debug.request": "发送给 Provider 的请求",
  "session.debug.requestUnavailable": "这一轮暂无 Provider 请求数据。",
