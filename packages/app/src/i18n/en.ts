export const dict = {
  ...
  "command.debug.toggle": "Toggle debug panel",
  ...
  "session.panel.debug": "Debug panel",
  "session.debug.empty": "No debug data yet",
  "session.debug.provider": "Provider",
  "session.debug.model": "Model",
  "session.debug.system": "System prompt tokens (est.)",
  "session.debug.total": "Total tokens",
  "session.debug.input": "Input tokens",
  "session.debug.output": "Output tokens",
  "session.debug.reasoning": "Reasoning tokens",
  "session.debug.cache": "Cache read / write",
  "session.debug.tokensUnit": "tokens",
  "session.debug.request": "Provider request",
  "session.debug.requestUnavailable": "Provider request data is not available for this turn.",
  ...
  "sidebar.gettingStarted.line1": "PPE Code includes free models so you can start immediately.",
